...
HD_PWD='C:/Users/abdud/Desktop/HWSWCodesign/HardwareSoftwareCodesign/Vivado_Project/SoC_Project/SoC_Project.runs/soc_design_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_design_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_design_axi_smc_0.tcl
