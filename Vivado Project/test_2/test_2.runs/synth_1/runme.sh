...
HD_PWD='C:/Projects/HWSW/Vivado Project/test_2/test_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log default_block_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source default_block_design_wrapper.tcl
