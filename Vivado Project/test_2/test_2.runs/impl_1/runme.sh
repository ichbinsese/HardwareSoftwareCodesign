...
HD_PWD='C:/Projects/HWSW/Vivado Project/test_2/test_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log default_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source default_block_design_wrapper.tcl -notrace
