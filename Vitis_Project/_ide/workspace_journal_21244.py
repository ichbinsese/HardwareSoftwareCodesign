...
platform = client.create_platform_component(name = "soc_platform",hw_design = "$COMPONENT_LOCATION/../../Vivado_Project/HWSW_Codesign/soc_design_wrapper.xsa",os = "standalone",cpu = "ps7_cortexa9_0",domain_name = "standalone_ps7_cortexa9_0",generate_dtb = False,advanced_options = advanced_options,compiler = "gcc")

platform = client.get_component(name="soc_platform")
status = platform.delete_domain(name="standalone_ps7_cortexa9_0")
...
domain = platform.get_domain(name="soc_domain")
