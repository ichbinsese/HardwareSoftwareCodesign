...
// Command     : write_verilog -force -mode synth_stub -rename_top soc_design_instruments_0_4 -prefix
//               soc_design_instruments_0_4_ soc_design_instruments_0_2_stub.v
...
(* CHECK_LICENSE_TYPE = "soc_design_instruments_0_2,instruments,{}" *) (* core_generation_info = "soc_design_instruments_0_2,instruments,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=instruments,x_ipVersion=1.0,x_ipCoreRevision=5,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "instruments,Vivado 2025.1" *) 
module soc_design_instruments_0_4(s00_axi_awaddr, s00_axi_awprot, 
