...
(* CHECK_LICENSE_TYPE = "soc_design_Instrument_Reader_0_0,Instrument_Reader,{}" *) (* core_generation_info = "soc_design_Instrument_Reader_0_0,Instrument_Reader,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=Instrument_Reader,x_ipVersion=1.0,x_ipCoreRevision=4,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4}" *) (* downgradeipidentifiedwarnings = "yes" *) 
