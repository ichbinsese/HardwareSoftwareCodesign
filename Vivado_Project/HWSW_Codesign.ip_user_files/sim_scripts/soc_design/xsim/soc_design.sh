...
#
# Script generated by Vivado on Mon Dec 01 20:49:23 +0100 2025
...
simulate()
{
  xsim soc_design -key {Behavioral:sim_1:Functional:soc_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_81cb.protoinst" -protoinst "protoinst_files/soc_design.protoinst" -log simulate.log
}
