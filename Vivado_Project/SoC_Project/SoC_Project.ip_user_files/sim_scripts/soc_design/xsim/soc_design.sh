...
#
# Script generated by Vivado on Sun Dec 07 11:46:52 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : soc_design.sh
...
#
# Usage        : soc_design.sh
#                soc_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                soc_design.sh [-reset_run]
#                soc_design.sh [-reset_log]
#                soc_design.sh [-help]
#
...
# script info
echo -e "soc_design.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./soc_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./soc_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: soc_design.sh [-help]\n\
Usage: soc_design.sh [-step]\n\
Usage: soc_design.sh [-lib_map_path]\n\
Usage: soc_design.sh [-reset_run]\n\
Usage: soc_design.sh [-reset_log]\n\
Usage: soc_design.sh [-keep_index]\n\
Usage: soc_design.sh [-noclean_files]\n\n\
