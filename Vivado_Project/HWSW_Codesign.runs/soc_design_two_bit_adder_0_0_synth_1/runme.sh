...
HD_PWD='C:/Users/azmib/Desktop/HardwareSoftwareCodesign/Vivado_Project/HWSW_Codesign.runs/soc_design_two_bit_adder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_design_two_bit_adder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_design_two_bit_adder_0_0.tcl
