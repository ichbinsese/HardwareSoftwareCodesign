...
HD_PWD='C:/Projects/HWSW/Vivado Project/test_2/test_2.runs/default_block_design_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log default_block_design_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source default_block_design_processing_system7_0_0.tcl
