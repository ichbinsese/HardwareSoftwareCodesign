...
HD_PWD='C:/Users/azmib/Desktop/HardwareSoftwareCodesign/Vivado_Project/SoC_Project/SoC_Project.runs/soc_design_Instrument_Reader_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_design_Instrument_Reader_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_design_Instrument_Reader_0_0.tcl
