...
platform = client.create_platform_component(name = "soc_platform",hw_design = "$COMPONENT_LOCATION/../../HardwareSoftwareCodesign/Vivado_Project/SoC_Project/soc_design_wrapper.xsa",os = "standalone",cpu = "ps7_cortexa9_0",domain_name = "standalone_ps7_cortexa9_0",generate_dtb = False,advanced_options = advanced_options,compiler = "gcc")
